...
export const metadata: Metadata = {
  title: "Contact",
  description: "Get in touch with Adelaja Obanijesu Israel about an AI automation, AI agent, CRM, AI video or front-end project.",
};
      ...
      <Container className="grid gap-16 lg:grid-cols-[1fr_1.2fr]">
        <Reveal immediate className="flex flex-col gap-8">
          <SectionHeading
            ...
            description="Have a workflow to automate, an AI agent to build, a sales pipeline to tidy or content to produce? Tell me what's slowing you down."
          />
